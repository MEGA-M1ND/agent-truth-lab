...
|-----|----------------|---------------|---------------|---------------|
| **A** | agent self-report | 35.8% [30.0%, 40.0%] | 0.0% [0.0%, 0.0%] | 14.2% [7.5%, 17.5%] |
| **B** | tool responses | 38.3% [35.0%, 42.5%] | 16.7% [10.0%, 20.0%] | 0.0% [0.0%, 0.0%] |
...
- Episodes ending in a violated expected_state: **61/120**
- Partial completions (some steps landed, others silently did not): **43**
- Duplicate side effects (double refunds / double charges): **11**
- Episodes with collateral damage outside the mission's frame: **15**
...
- Episodes needing recovery: **61**
- Auto-recovered: **44** (72.1%)
- Escalated with a structured incident report: **17**
...
- Agent: 1,340,387 input / 104,837 output tokens, ~12.77s per episode
- Verifier: **0 tokens**, ~7.2ms and ~20 DB reads per episode
