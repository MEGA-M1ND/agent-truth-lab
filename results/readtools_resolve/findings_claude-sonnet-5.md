...
|-----|----------------|---------------|---------------|---------------|
| **A** | agent self-report | 24.2% [22.5%, 25.0%] | 0.0% [0.0%, 0.0%] | 12.5% [10.0%, 15.0%] |
| **B** | tool responses | 39.2% [35.0%, 42.5%] | 15.8% [7.5%, 20.0%] | 0.0% [0.0%, 0.0%] |
...
- Episodes ending in a violated expected_state: **63/120**
- Partial completions (some steps landed, others silently did not): **38**
...
- Episodes needing recovery: **63**
- Auto-recovered: **47** (74.6%)
- Escalated with a structured incident report: **16**
...
- Agent: 1,352,344 input / 96,984 output tokens, ~14.23s per episode
